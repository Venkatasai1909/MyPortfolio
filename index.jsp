	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Java Developer</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - Database Development</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">I'm a Java Developer looking for an entry level developer role
					in an organization where I can utilise my skills to the atmost.
					</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">
					  I'm also proficient in Oracle database , front-end technologies like 
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href=""> <i
					class="fas fa-download me-2"></i> Resume Download!
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						S.R Nagar <br /> Hyderabad,Telangana.500034
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Java Developer</h4>
					<p class="lead mb-0">
						Java Developer is a role where you need to lookAfter server side development
